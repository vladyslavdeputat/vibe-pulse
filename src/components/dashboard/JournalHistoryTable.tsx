    ...
    return (
      <>
        <td className="px-3 sm:px-6 py-3 sm:py-4 align-middle">
          <div className="text-xs sm:text-sm">{formatDate(entry.created_at)}</div>
        ...
        <td className="px-3 sm:px-6 py-3 sm:py-4 align-middle capitalize">
          <span className="text-xs sm:text-sm">{entry.topic}</span>
        </td>
        <td className="px-3 sm:px-6 py-3 sm:py-4 align-top max-w-md">
          <div className="rounded-lg border border-border/40 bg-muted/30 p-2 sm:p-3">
